...
- Consider adding `requirements.txt` or `pyproject.toml` for reproducible installs.

If you'd like, I can add `requirements.txt`, run the server and show sample responses, or add unit tests for the endpoints.
